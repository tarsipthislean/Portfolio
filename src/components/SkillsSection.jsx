...
const skills = [
  ...
  { name: "MongoDB", level: 80, category: "language" },
  ...
  { name: "Next.js", level: 89, category: "frameworks" },
...
const categories = ["all", "language", "frameworks", "tools"];
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredSkills.map((skill, key) => (
            <div
              key={key}
              className="bg-card p-6 rounded-lg shadow-xs transition-transform transform hover:translate-y-2 hover:shadow-lg"
            >
